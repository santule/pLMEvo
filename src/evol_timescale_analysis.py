...
def evol_scale_correlation_analysis(fasta_aln_file,model_type):
...
if __name__ == "__main__":
    ...
    lg_corr_avg,lg_corr_sparse,lg_corr_near = evol_scale_correlation_analysis(fasta_aln_file,model_type)
